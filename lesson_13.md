...
| :-- | :-- | -- |
| `clear` | ![Clear](clear.png) | Clears all pen marks from the stage. |
| `pen up` | ![Pen Up](penup.png) | Picks up the pen from the stage. |
| `pen down` | ![Pen Down](pendown.png) | Puts down the pen on the stage. |
| `set pen color to` | ![set pen color to](set_pen_color_to.png)| Sets the pen color to the indicated color. |
| `set pen size to` |![set pen size to](set_pen_size_to.png)| Set the pen thickness to 1. |
| `change pen size by` | ![change pen size by](change_pen_size_by.png) | Changes the pen size by 1. |

### Introduce the following Blocks from the Looks Category

| Block name | Block Image | Description |
| :-- | :-- | -- |
| `Show` | ![Show](show.png) | Shows the sprite on the stage. |
| `Hide` | ![Hide](hide.png) | Hides the Sprite from the stage. |
